    ...
    <div className="space-y-6">
      ...
      {favorites.length === 0 ? (
        <div className="py-20 text-center">
          ...
          <p className="text-[var(--color-text-secondary)] text-sm mb-1">Belum ada manga favorit</p>
          <p className="text-[var(--color-text-muted)] text-[13px]">Klik ikon hati di manga untuk menambahkan ke favorit</p>
        </div>
      ) : (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {favorites.map((item) => (
