    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 pb-10">
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="max-w-2xl mx-auto flex flex-col">
              ...
              {results.length > MAX_RESULTS && (
                <button
                  ...
                  className="mt-1 py-2.5 text-[13px] font-medium text-[var(--color-accent)] hover:text-[var(--color-accent-hover)] transition-colors duration-150 text-center"
                >
          ...
          {!hasSearched && !loading && (
            <div className="text-center py-16">
              <p className="text-[var(--color-text-muted)] text-[13px]">Ketik judul manhwa untuk mulai mencari</p>
            </div>
          )}
        </div>
      </div>
